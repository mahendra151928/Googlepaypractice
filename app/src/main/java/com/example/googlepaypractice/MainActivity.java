package com.example.googlepaypractice;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button send,btndiscription;
    TextView discription,showless;
    String TAG ="main";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btndiscription=findViewById(R.id.btndiscription);
        discription=findViewById(R.id.discription);
        showless=findViewById(R.id.showless);


        btndiscription.setOnClickListener(new View.OnClickListener() {
            @Override
